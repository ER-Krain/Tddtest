...
class NewVisitorTest(StaticLiveServerTestCase):  #(1)
    ...
    def setUp(self):  #(3)
        ...
        self.live_server_url = 'http://47.95.0.51'
    ...
    def test_layout_and_styling(self):
        ...
        #she starts a new and sees the input is nicely
        #centered there too
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ##od edith's is coming through from cookies ect
        self.browser.quit()
        self.browser = webdriver.Firefox()

        #francis visits the home page. there is no sgin of edith's
        #list
        self.browser.get(self.live_server_url)
